...
AddEventHandler('Framework:Client:OnPlayerUnload', function()
    -- TriggerEvent('pepe-lapraces:client:LeaveRace')
    if CurrentRaceData ~= nil then
    TriggerServerEvent('pepe-lapraces:server:LeaveRace', CurrentRaceData)
    end
end)

RegisterNetEvent('pepe-lapraces:client:StartRaceEditor')
AddEventHandler('pepe-lapraces:client:StartRaceEditor', function(RaceName)
...
RegisterNetEvent('pepe-lapraces:client:UpdateRaceRacerData')
AddEventHandler('pepe-lapraces:client:UpdateRaceRacerData', function(RaceId, RaceData)
...
RegisterNetEvent('pepe-lapraces:client:JoinRace')
AddEventHandler('pepe-lapraces:client:JoinRace', function(Data, Laps)
...
RegisterNetEvent('pepe-lapraces:client:RaceCountdown')
AddEventHandler('pepe-lapraces:client:RaceCountdown', function()
    TriggerServerEvent('pepe-lapraces:server:UpdateRaceState', CurrentRaceData.RaceId, true, false)
                ...
                if CheckpointDistance < MaxDistance then
                    if CurrentRaceData.TotalLaps == 0 then
                        if CurrentRaceData.CurrentCheckpoint + 1 < #CurrentRaceData.Checkpoints then
                            ...
                            SetNewWaypoint(CurrentRaceData.Checkpoints[CurrentRaceData.CurrentCheckpoint + 1].coords.x, CurrentRaceData.Checkpoints[CurrentRaceData.CurrentCheckpoint + 1].coords.y)
                            TriggerServerEvent('pepe-lapraces:server:UpdateRacerData', CurrentRaceData.RaceId, CurrentRaceData.CurrentCheckpoint, CurrentRaceData.Lap, false)
                            DoPilePfx()
                            ...
                            PlaySound(-1, "SELECT", "HUD_FRONTEND_DEFAULT_SOUNDSET", 0, 0, 1)
                            CurrentRaceData.CurrentCheckpoint = CurrentRaceData.CurrentCheckpoint + 1
                            TriggerServerEvent('pepe-lapraces:server:UpdateRacerData', CurrentRaceData.RaceId, CurrentRaceData.CurrentCheckpoint, CurrentRaceData.Lap, true)
                            FinishRace()
                        end
                    else
                        if CurrentRaceData.CurrentCheckpoint + 1 > #CurrentRaceData.Checkpoints then
...
RegisterNetEvent('pepe-lapraces:client:PlayerFinishs')
...
RegisterNetEvent('pepe-lapraces:client:WaitingDistanceCheck')
AddEventHandler('pepe-lapraces:client:WaitingDistanceCheck', function()
    Wait(1000)
    Citizen.CreateThread(function()
        while true do
