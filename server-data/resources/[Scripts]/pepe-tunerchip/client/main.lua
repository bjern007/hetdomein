...
RegisterNUICallback('save', function(data)
    Framework.Functions.TriggerCallback('pepe-tunerchip:server:HasChip', function(HasChip)
        if HasChip then
            ...
            setVehData(veh, data)
            Framework.Functions.Notify('Tuning opgeslagen!', 'error')
...
RegisterNUICallback('reset', function(data)
    ...
    local veh = GetVehiclePedIsUsing(ped)
    resetVeh(veh)
    Framework.Functions.Notify('Tuner Tablet: Reset!', 'error')
end)
...
AddEventHandler('pepe-tunerchip:client:openChip', function()
    ...
    if inVehicle then
        Framework.Functions.Progressbar("connect_laptop", "Tuner Tablet verbinden...", 2000, false, true, {
