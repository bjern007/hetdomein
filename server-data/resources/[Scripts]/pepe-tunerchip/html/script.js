...
$(document).on('click', '#save', function(){
    $.post('http://pepe-tunerchip/save', JSON.stringify({
...
$(document).on('click', '#reset', function(){
    $.post('http://pepe-tunerchip/reset');
});
...
$(document).on('click', "#save-neon", function(){
    if (RainbowNeon) {
        $.post('http://pepe-tunerchip/saveNeon', JSON.stringify({
...
$(document).on('click', '#save-headlights', function(){
    $.post('http://pepe-tunerchip/saveHeadlights', JSON.stringify({
        value: headlightVal,
...
$(document).on('click', '#save-stancer', function(){
    ...
    $.post('http://pepe-tunerchip/SetStancer', JSON.stringify({
...
QBTuner.Open = function() {
    $.post('http://pepe-tunerchip/checkItem', JSON.stringify({item: "tunerlaptop"}), function(hasItem){
        if (hasItem) {
