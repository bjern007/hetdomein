                ...
                if IsControlJustPressed(0, Keys[v]) or IsDisabledControlJustPressed(0, Keys[v]) then
                    ...
                    if next(keyMeta) ~= nil then
                        if keyMeta[v]["command"] ~= "" then
                            ...
                            Framework.Functions.Notify('Je hebt nog niks gekoppeld aan ['..v..'], gebruik /binds om te beginnen met koppelen', 'primary', 4000)
                        end
                    else
                        Framework.Functions.Notify('Je hebt nog niks gekoppeld, gebruik /binds om te beginnen met koppelen', 'primary', 4000)
                    end
                end
            end
            if keyPressed then
...
RegisterNUICallback('save', function(data)
    ...
    Framework.Functions.Notify('Commandbindings opgeslagen!', 'success')
