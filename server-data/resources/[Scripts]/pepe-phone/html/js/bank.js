...
QB.Phone.Functions.DoBankOpen = function() {
    ...
    $(".bank-app-account-balance").html("&euro; "+QB.Phone.Data.PlayerData.money.bank.toFixed());
    $(".bank-app-account-balance").data('balance', QB.Phone.Data.PlayerData.money.bank.toFixed());
