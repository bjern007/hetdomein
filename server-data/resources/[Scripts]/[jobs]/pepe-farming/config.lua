...
Config.SellLocation =  {x = 1961.31, y = 5184.88, z = 47.96}
...
Config.ItemList = {
    ["orange"] = math.random(3, 11),
    ["milk"] = math.random(15, 18),
	["corn_kernel"] = math.random(15, 20),
    ["corn_packet"] = math.random(80, 180),
    ["milk_pack"] = math.random(80, 180),
	["fruit_pack"] = math.random(80, 180),
}

Config.Blips = {
   	{title="Koeien Boerderij", colour=89, id=141, x = 2478.392578125, y = 4728.8315429688, z = 34.303840637207},
	{title="Mais veld", colour=16, id=140, x = 2041.5297851562, y = 4854.5625, z= 43.097927093506},
	{title="Boerderij", colour=16, id=210, x = 2195.4331054688, y = 5602.6352539062, z = 53.584144592285},
	{title="Sinasappel veld", colour=17, id=130, x = 346.62341308594, y = 6522.9448242188, z = 28.830759048462},
}
